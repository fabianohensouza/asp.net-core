    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SwitchID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SwitchModelo = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    SwitchSerial = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    SwitchAcesso = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    SwitchPortas = table.Column<int>(type: "int", nullable: false),
                    SwitchBackup = table.Column<bool>(type: "bit", nullable: false),
                    SwitchObs = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    LastChange = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CoopID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UnidadeID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FabricanteID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Switches_Coops_CoopID",
                        column: x => x.CoopID,
                        principalTable: "Coops",
                        principalColumn: "CoopID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Switches_Fabricantes_FabricanteID",
                        column: x => x.FabricanteID,
                        principalTable: "Fabricantes",
                        principalColumn: "FabricanteID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Switches_Unidades_UnidadeID",
                        column: x => x.UnidadeID,
                        principalTable: "Unidades",
                        principalColumn: "UnidadeID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Switches_CoopID",
                table: "Switches",
                column: "CoopID");

            migrationBuilder.CreateIndex(
                name: "IX_Switches_FabricanteID",
                table: "Switches",
                column: "FabricanteID");

            migrationBuilder.CreateIndex(
                name: "IX_Switches_UnidadeID",
                table: "Switches",
                column: "UnidadeID");
